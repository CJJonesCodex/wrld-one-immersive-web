...
export function World({ progress, activeWorld, quality, pointer, sensor, onSelectWorld, haptics, worlds, reducedMotion, phaseState, mobileDrawerOpen, detailOpen, isMobile, isMobileFit, revealRuntime, vfxPreset, continuity }: WorldProps) {
